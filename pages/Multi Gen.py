...
def generate_content(prompt, model="claude-3-opus-20240229", max_tokens=2000, temperature=0.4):
...
def quickArticleCreate(qry, model="claude-3-opus-20240229-16k", max_tokens=3000):
